...
public final class MedicineSqlUtils {
    ...
    ///
    /// @param event the [MedicineEvent] whose embedded [dz.anisbouhadida.medzloader.domain.model.Medicine] provides the key values
    ...
    /// @return a [MapSqlParameterSource] containing `registrationNumber`, `code`,
    ///         `icd`, `brandName`, and `laboratoryHolder`
    public static MapSqlParameterSource compositeKeyParams(String registrationNumber, String code, String internationalCommonDenomination, String brandName, String laboratoryHolder) {
        return new MapSqlParameterSource()
