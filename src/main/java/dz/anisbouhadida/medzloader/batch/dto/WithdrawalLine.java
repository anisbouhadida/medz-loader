...
/// @param registrationNumber                   official registration number (e.g. `156/01 A 001/99`)
...
/// @param form                                 pharmaceutical form (e.g. _COMPRIMÉ_, _GÉLULE_) — may be blank
...
/// @param type                                 medicine type as raw string (`GE`/`G` for generic, `RE`/`R` for reference, or blank)
/// @param status                               registration origin as raw string (`F` for finalized, `I` for in progress)
/// @param withdrawalDate                       date of withdrawal as raw string — may be an ISO date, a localised text, or blank
