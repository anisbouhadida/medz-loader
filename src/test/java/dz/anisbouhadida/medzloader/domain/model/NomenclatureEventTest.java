...
class NomenclatureEventTest {
    ...
    void setUp() {
        medicine = new Medicine(
                ...
                "SANOFI", "FRANCE",
                LocalDateTime.of(2017, 1, 15, 0, 0, 0), null, null, 0
        );
        event = new NomenclatureEvent(
                medicine,
                LocalDateTime.of(2025, 1, 15, 0, 0, 0),
                "24 MOIS",
                "Observation test"
        );
    }
    ...
    void constructor_should_setAllFields() {
        assertAll(
                ...
                () -> assertThat(event.finalRegistrationDate()).isEqualTo(LocalDateTime.of(2025, 1, 15, 0, 0, 0)),
