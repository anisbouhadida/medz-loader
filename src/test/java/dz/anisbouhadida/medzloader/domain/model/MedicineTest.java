...
class MedicineTest {
    ...
    void constructor_should_storeAllFields_when_fullyPopulated() {
        ...
        var medicine = new Medicine(
                "035/01 A 003/17/23", "01 A 003",
                "PARACETAMOL", "DOLIPRANE", "COMPRIMÉ", "500MG",
                "B/16", "LISTE I", "120.00", "150.00",
                "SANOFI", "FRANCE",
                registrationDate, MedicineType.GE, MedicineOrigin.MANUFACTURED, 1
        );
    ...
    void constructor_should_acceptNulls_when_optionalFieldsAreNull() {
        var medicine = new Medicine(
                "035/01 A 003/17/23", "01 A 003",
                "PARACETAMOL", "DOLIPRANE", null, null,
                null, null, null, null,
                "SANOFI", "FRANCE",
                null, null, null, 0
        );
    ...
    void equals_should_returnTrue_when_allFieldsMatch() {
        ...
        var med1 = new Medicine("REG", "CODE", "INN", "BRAND", "FORM", "DOSE",
                "PACK", "LIST", "P1", "P2", "LAB", "COUNTRY",
                date, MedicineType.RE, MedicineOrigin.IMPORTED, 0);
        var med2 = new Medicine("REG", "CODE", "INN", "BRAND", "FORM", "DOSE",
                "PACK", "LIST", "P1", "P2", "LAB", "COUNTRY",
                date, MedicineType.RE, MedicineOrigin.IMPORTED, 0);
    ...
    void hashCode_should_beConsistent_when_equalObjects() {
        ...
        var med1 = new Medicine("REG", "CODE", "INN", "BRAND", "FORM", "DOSE",
                "PACK", "LIST", "P1", "P2", "LAB", "COUNTRY",
                date, MedicineType.BIO, MedicineOrigin.MANUFACTURED, 2);
        var med2 = new Medicine("REG", "CODE", "INN", "BRAND", "FORM", "DOSE",
                "PACK", "LIST", "P1", "P2", "LAB", "COUNTRY",
                date, MedicineType.BIO, MedicineOrigin.MANUFACTURED, 2);
